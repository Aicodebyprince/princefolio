    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="text-center mb-20">
                ...
                <p className="text-lg text-gray-300 font-light">Technologies I use to build amazing things</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10">
                ...
                <Card3D className="glass-card rounded-3xl p-10">
                    <div className="flex items-center mb-10">
                        ...
                        <h3 className="text-xl font-bold gradient-text">DevOps & Tools</h3>
                    </div>
                    <div className="space-y-6">
            ...
            <div className="mt-20">
                <Card3D className="glass-card rounded-3xl p-12 text-center">
                    <h3 className="text-xl font-bold gradient-text mb-8">Technologies I Work With</h3>
