    ...
    return (
        <div className="max-w-6xl mx-auto">
                ...
                {projects.map((project, index) => {
                    ...
                    return (
                        <div key={index} className="project-showcase project-card rounded-2xl overflow-hidden">
                            <div className="h-56 bg-gradient-to-br from-blue-500/10 via-purple-600/10 to-pink-500/10 flex items-center justify-center relative">
                                ...
                                <div className="project-overlay">
                                    <div className="text-center p-4">
                                        <h4 className="text-xl font-bold mb-4">{project.shortTitle}</h4>
                                        ...
                                        <div className="flex gap-3 justify-center">
                                            ...
                                            <a href={project.liveUrl} target="_blank" rel="noopener noreferrer" className="border-2 border-white px-5 py-2 rounded-lg text-xs font-bold hover:bg-white/10 transition-all">
                                                Live Demo
                                            </a>
                                        </div>
                                    </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center text-xs text-green-400">
                                    {StatIcon && <StatIcon className="w-4 h-4 mr-2" />}
                                    {project.stat}
                                </div>
                            </div>
                        </div>
            ...
            <div className="text-center mt-16">
                <a href="https://github.com/alexchen" target="_blank" rel="noopener noreferrer" className="btn-primary inline-block px-10 py-4 rounded-xl font-bold text-base">
