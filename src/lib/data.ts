...
import { GraduationCap, School, Code, Layers, Paintbrush, Puzzle, UserPlus, MessageSquare, Bot } from 'lucide-react';
...
export const projects: Project[] = [
    ...
    },
    {
        ...
        techStack: [
            ...
            { name: "Communication Channel", description: "WhatsApp Business API (The platform for user interaction)." },
        ...
        workflow: [
            { 
                ...
                description: "The workflow starts when a user sends a message to the business's WhatsApp number. The WhatsApp Trigger node in n8n securely listens for these incoming messages.",
                imageUrl: "https://picsum.photos/800/450",
                dataAiHint: "workflow trigger"
            },
            {
                title: "AI Agent (Gemini)",
                description: "The message content is passed to the AI Agent node. This node is the core of the bot's intelligence. It uses the Google Gemini model to understand the user's intent. Simple Memory is used to remember the last 10 messages, allowing it to understand context.",
                imageUrl: "https://picsum.photos/800/450",
                dataAiHint: "ai agent"
            },
            {
                title: "Tool Execution",
                description: "The agent is connected to three tools (Get Inventory, Get FAQ, Post Orders) that allow it to interact with our Google Sheets database.",
                imageUrl: "https://picsum.photos/800/450",
                dataAiHint: "data tools"
            },
            {
                title: "Send Message (WhatsApp)",
                description: "The final response generated by the AI Agent is passed to the Send Message node. This node sends the text back to the user on WhatsApp, completing the loop.",
                imageUrl: "https://picsum.photos/800/450",
                dataAiHint: "message sending"
            }
        ],
        ...
        futureImprovements: [
            "Connect the workflow to a payment gateway like Stripe to accept payments directly in the chat.",
            "Integrate a more persistent memory solution (like a database) to remember customer preferences across different conversations.",
            "Add a feature to send order status updates (e.g., \"Your order is being prepared,\" \"Your order is out for delivery\")."
        ]
    },
    {
        icon: 'vault',
